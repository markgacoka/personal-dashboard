...
// Read-only against production flight data; the only write here is the
// user's own choice record (flight_track_choice), which nothing else reads.
import { pool } from '../db/client.js'
import { getComparison } from '../services/trackCompare.js'
